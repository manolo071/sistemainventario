        ...
        if (Input::hasFile('import_file')) {
            ...
            foreach ($csv as $key => $value) {
                if($key != 0) {
                    ...
                    $data[$key]['customer_name'] = trim($value[0]);
                    $data[$key]['email'] = trim($value[1]);
                    $data[$key]['phone'] = trim($value[2]);
                    $data[$key]['billing_street'] = trim($value[3]);
                    $data[$key]['billing_city'] = trim($value[4]);
                    $data[$key]['billing_state'] = trim($value[5]);
                    $data[$key]['billing_zip_code'] = trim($value[6]);
                    $data[$key]['billing_country_id'] = trim($value[7]);
                    
                    $data[$key]['shipping_street'] = trim($value[8]);
                    $data[$key]['shipping_city'] = trim($value[9]);
                    $data[$key]['shipping_state'] = trim($value[10]);
                    $data[$key]['shipping_zip_code'] = trim($value[11]); 
                    $data[$key]['shipping_country_id'] = trim($value[12]);
