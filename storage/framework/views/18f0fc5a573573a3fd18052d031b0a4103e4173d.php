<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form action="<?php echo e(url('receive/update')); ?>" method="POST" id="receiveForm">
        ...
        <input type="hidden" value="<?php echo e($oderInfo->id); ?>" name="id" id="id">
          ...
          <div class="col-md-8">
            ...
            <h5>
              Receive No # <?php echo e(sprintf("%04d", $oderInfo->id)); ?>
                  ...
                  ?>
                    ...
                    ?>
                      <?php if(($result->quantity)>0): ?>
                        ...
                        <td class="text-center" id="orderqtyid<?php echo e($result->item_id); ?>"><?php echo e(itemQtyInOrder($oderInfo->order_no,$oderInfo->id,$result->item_code)); ?></td>


                          <td><input class="form-control text-center no_units" name="quantity[]" value="<?php echo e($result->quantity); ?>" rowid="<?php echo e($result->item_id); ?>" type="text">
                          <input type="hidden" name="old_qty[]" value="<?php echo e($result->quantity); ?>">
                          </td>
