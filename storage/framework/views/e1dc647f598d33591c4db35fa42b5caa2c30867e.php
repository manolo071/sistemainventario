<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <!-- /.box-header -->
        <div class="box-body">
        <form action="<?php echo e(url('transfer/save')); ?>" method="POST" id="transferForm">  
        <input type="hidden" value="<?php echo e(csrf_token()); ?>" name="_token" id="token">
        <div class="row">
            <div class="col-md-3">
              <div class="form-group">
                  <label class="require control-label" for="exampleInputEmail1"><?php echo e(trans('message.form.source')); ?></label>
                  <select class="form-control select2" name="source" id="source">
                    ...
                    <?php foreach($locationList as $data): ?>
                      <option value="<?php echo e($data->loc_code); ?>" ><?php echo e($data->location_name); ?></option>
                    <?php endforeach; ?>
                    </select>
              </div>
            </div>
            ...
            <div class="col-md-3">
              <div class="form-group">
                  <label class="require control-label" for="exampleInputEmail1"><?php echo e(trans('message.form.destination')); ?></label>
            ...
            <div class="col-md-3">
              <div class="form-group">
                <label class="control-label require"><?php echo e(trans('message.table.date')); ?>:</label>
        ...
        <div class="row">
            <div class="col-md-12">
              <div class="box-header text-center">
                <h3 class="box-title"><b><?php echo e(trans('message.form.stock_move')); ?></b></h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body no-padding">
                ...
                <table class="table table-bordered" id="transferTbl">
                  ...
                  <tr class="tbl_header_color dynamicRows">
                    <th width="75%" class="text-center"><?php echo e(trans('message.form.item_name')); ?></th>
                    <th width="20%" class="text-center"><?php echo e(trans('message.table.quantity')); ?></th>
                    <th width="5%"><?php echo e(trans('message.table.action')); ?></th>
                  </tr>
                  <tr class="tableInfo"><td colspan="1" align="right"><strong><?php echo e(trans('message.invoice.total')); ?></strong></td><td align="center" colspan="1" id="total_qty" style="font-weight:bold;" width="20%"></td></tr>
                  </tbody>
                </table>
                </div>
                <br><br>
              ...
              <div class="form-group">
                ...
                <a href="<?php echo e(URL::to('/')); ?>/transfer/list" class="btn btn-info btn-flat"><?php echo e(trans('message.form.cancel')); ?></a>
                <button id="btnSubmit" type="submit" class="btn btn-primary btn-flat pull-right"><?php echo e(trans('message.form.submit')); ?></button>
              </div>
        </div>
        </form>
      </div>
