      ...
      <div class="box box-default">
        ...
        <div class="box">
           <div class="panel-body">
            ...
            <form class="form-horizontal" action="<?php echo e(url('purchase/filtering')); ?>" method="GET" id='salesHistoryReport'>
              ...
              <div class="col-md-3">
                ...
                <?php foreach($suppliers as $data): ?>
                  <option value="<?php echo e($data->id); ?>" <?= ($data->id == $supplier) ? 'selected' : ''?>><?php echo e($data->name); ?></option>
                <?php endforeach; ?>
                </select>
              </div>
              ...
              <div class="col-md-3">
                ...
                <?php foreach($items as $data): ?>
                  <option value="<?php echo e($data->stock_id); ?>" <?= ($data->stock_id == $stock_id) ? 'selected' : ''?>><?php echo e($data->name); ?></option>
                <?php endforeach; ?>
                </select>
              </div>
